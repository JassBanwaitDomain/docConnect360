                            ...
                            <div className="lg:col-span-2">
                                {data.isApproved==='pending' && (
                                    <div className="flex p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg">
                                        ...
                                        className="flex-shrink-0" width='20' height='24'  fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="mt-8">
                                    {tab==='overview' && <div>
                                        <div className="flex items-center gap-5 mt-0 mb-12">
                                            <figure className="max-w-[200px] max-h-[250px]">
                                                <img src={data?.photo} alt="this is doctors' image" className=" h-full" />
                                            </figure>
                                            <div>
                                                ...
                                                <p className=" font-[10px]  lg:max-w-[390px] leading-6 text-justify">
                                                    {data?.bio}
                                                </p>
                                            </div>
                                        </div>    
