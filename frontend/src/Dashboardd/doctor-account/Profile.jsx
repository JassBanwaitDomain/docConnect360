...
const Profile=({doctorData})=>{
    ...
    const addQualification= e =>{
        ...
        addItem('qualifications',{
            ...
            endingDate:"",
            degree:"PHD",
            university:"DMC Medical College"
        });
    };
            ...
            <div>
                ...
                <form>
                    ...
                    <div className="mb-5">
                        ...
                        <input type="text" name="bio" value={formData.bio} onChange={handleInputChange} placeholder="Bio" className="form__input" maxLength={500} />
                    </div>

                    <div className="mb-5">
                        <div className="grid grid-cols-3 gap-5 mb-[30px]">
                            <div>
                                <p className="form__label">Gender*
                    ...
                    <div>
                        <p className="form__label">Specialization*
                                ...
                                <div key={index}>
                                    <div>
                                        <div className="grid grid-cols-2 gap-5">
                                            ...
                                            <div>
                                                <p>Ending Date*</p>
                                                <input type="date" name="endingDate" value={item.ingDate} className="form__input" onChange={e =>handleQualificationChange(e,index)} />
                                            </div>
                                        </div>
                                ...
                                <div key={index}>
                                    <div>
                                        <div className="grid grid-cols-2 gap-5">
                                            ...
                                            <div>
                                                <p>Ending Date*</p>
                                                <input type="date" name="endingDate" value={item.ingDate} className="form__input" onChange={e =>handleExperienceChange(e,index)} />
                                            </div>
                                        </div>
                                        <div className="grid grid-cols-2 gap-5 mt-5">
                                            <div>
