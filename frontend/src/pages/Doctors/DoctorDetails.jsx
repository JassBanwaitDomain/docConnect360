            ...
            <div className="max-w-[1170px] px-5 mx-auto">
                ...
                {!loading && !error && <div className="grid md:grid-cols-3 gap-[50px]">
                    <div className="md:col-span-2">
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <p className="text__para tex-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">{bio}</p>
                    ...
                    <div className="mt-[50px] border-b border-solid border-[#0066ff34]">
                            ...
                            'feedback' && "border-b border-solid border-primaryColor"} py-2 px-5 mr-5 text-[16px] leading-7 text-headingColor font-semibold`} onClick={()=>setTab('feedback')}>Feedback</button>
                        </div>
