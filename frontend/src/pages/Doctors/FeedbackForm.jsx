...
const FeedbackForm=()=>{
    ...
    return(
        ...
        <form action="">
            <div>
                ...
                <div>
                    {[...Array(5).keys()].map((_,index)=>{
                        ...
                        `} type="button" onClick={()=>setRating(index)} onMouseEnter={()=>setHover(index)} onMouseLeave={()=>setHover(rating)} onDoubleClick={()=>{
                            setHover(0);
                            setRating(0);
                        }}>
            ...
            <button type="submit" className="btn bg-primaryColor" onClick={handleSubmitReview}> { loading ? <HashLoader size={25} color="#fff"/>: 'Submit Feedback'}</button>
        </form>
